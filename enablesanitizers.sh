...
usage()
{
    echo "Script for enabling CLang sanitizers for debug builds. Only tested on Ubuntu x64."
    echo "run like this: . configsanitizers.sh (note the dot+space to preserve changes to environment variables - don't use ./ instead)"    
